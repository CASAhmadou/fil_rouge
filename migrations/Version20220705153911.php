 ...
 */
final class Version20220705153911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger DROP menu_burger_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger ADD menu_burger_id INT DEFAULT NULL');
    }
}
